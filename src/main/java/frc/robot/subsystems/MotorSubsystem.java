...
public class MotorSubsystem extends SubsystemBase {
    // Remove all modification if broke
    private static MotorSubsystem ms;
...
private HashMap<String, TalonFX> m_motors;


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    

    public MotorSubsystem(HashMap<String, TalonFX> motors) {
        //m_motors = motors;
        m_motors = new HashMap<String, TalonFX>();

        m_motors.put("1",new TalonFX(17));
        m_motors.put("2",new TalonFX(19));
        m_motors.put("3",new TalonFX(15));
        m_motors.put("4",new TalonFX(21));
